...
class MainMenu(Menu):
    ...
    def displayMenu(self):
        ...
        while self.runDisplay:
            ...
            self.game.drawText('Main Menu', 80, self.game.displayW/2, self.game.displayH/2 - 50)
...
class optionsMenu(Menu):
    def __init__(self, game):
        ...
        self.LevelsX, self.LevelsY = self.midW, self.midH + 70
    ...
    def displayMenu(self):    #Name must match name under init above
        ...
        while self.runDisplay:
            ...
            self.game.drawText("Levels", 40, self.LevelsX, self.LevelsY)
            self.drawCursor()
            self.blitScreen()
